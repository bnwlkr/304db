...
export default class BuyCommodity extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            ...
            <div class="row">
               <div class="col-lg-6" align="left">
                   ...
                   <div class="panel-heading"><h5>Buy commodity</h5>
                     <form>
                             ...
                             <button type="submit" class="btn btn-defoult" align="right">Buy</button>
                             </form>
